...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if (!avatarLocalPath) {
        throw new ApiError(400, "Avatarfile is reqired")
    }
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    const { accessToken, refreshToken } = await generateAccessAndRefreshTokens(userData.id)
...
const updateAccountDetails = asyncHandler(async(req, res) => {
    ...
    if(!(fullName || email)){
        throw new ApiError(400, "fullname and eamil is required")
    }
